...
describe('FootballMatchesComponent', () => {
  ...
  it("Should show no results found if API returns no data", async () => {
    const yearList = getYearList();
    yearList[6].click();
  ...
  it('Should render the matches list after data is fetched from API - 1', async () => {
    const yearList = getYearList();
    yearList[0].click();
    await fixture.detectChanges();
    await fixture.whenStable();
  ...
  it('Should render the matches list after data is fetched from API - 2', async () => {
    const yearList = getYearList();
    yearList[2].click();
    await fixture.detectChanges();
    await fixture.whenStable();
